...
import { QuackSwapWeb3Provider } from './hooks';
...
export function QuackSwapProvider({
  chainId,
  library,
  children,
  account,
  ...
  return (
    <QuackSwapWeb3Provider chainId={chainId} library={library} account={account}>
      <ListsUpdater />
      <ApplicationUpdater />
      <MulticallUpdater />
      <TransactionUpdater />
