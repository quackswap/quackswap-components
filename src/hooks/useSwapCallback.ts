...
import { useQuackSwapWeb3 } from './index';
...
function useSwapCallArguments(
  ...
  const { account, chainId, library } = useQuackSwapWeb3();
                ...
                return contract.callStatic[methodName](...args, options)
                  ...
                  .catch((callError) => {
                    ...
                    switch (callError.reason) {
                      case 'QuackSwapRouter: INSUFFICIENT_OUTPUT_AMOUNT':
                      case 'QuackSwapRouter: EXCESSIVE_INPUT_AMOUNT':
                        errorMessage =
