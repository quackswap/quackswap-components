import { CBTT, ChainId, Currency, Token, currencyEquals } from '@@hotcrosscom/quackswap-sdk';
...
const SelectTokenDrawer: React.FC<Props> = (props) => {
  ...
  const currencies = useMemo(() => {
    if (searchQuery === '') {
      ...
      const _tokens = filteredSortedTokens.filter((token) => token !== CBTT[chainId]);
      return [CBTT[chainId], ..._tokens];
    }
    return filteredSortedTokens;
  }, [filteredSortedTokens, chainId]);
  //const currencies = useMemo(() => [Currency.CBTT, ...filteredSortedTokens], [filteredSortedTokens]);
